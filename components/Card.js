...
function Card() {
    ...
    const [cards, setCards] = useState([
      {
        id: 0,
        images: '/images/ömerfitnes.jpg',

        content: `Son altı ayda, koçum Ali'nin yönlendirmesiyle uyguladığım haftada üç gün süren full body antrenman programı, sporla ilgili olmayan bazı sakatlıklarım olmasına rağmen oldukça başarılı geçti. Ali, bu sakatlıkları dikkate alarak programı öyle bir şekilde düzenledi ki, antrenmanlar sırasında acıyı tamamen sıfıra indirebildik. Bu sayede, kollarım, sırtım ve bacaklarım dahil olmak üzere tüm vücut bölgelerimde sağlıklı ve dengeli bir şekilde gelişme kaydettim. Spor programının genel verimliliği, hem sakatlıklarımın iyileşme sürecine katkı sağladı hem de vücudumu daha sağlam ve dirençli hale getirdi. Bu süreçte Ali'nin profesyonel yaklaşımı ve kişisel ihtiyaçlarıma gösterdiği özen, spordan aldığım verimi maksimize etmemi sağladı. Bu sürecin genel sağlığın ve yaşam kalitem üzerindeki olumlu etkileri sayesinde her günü daha verimli ve mutlu geçirmeye başladım.`,
        person: 'Ömer',
        isVisible: true
      },
      {
