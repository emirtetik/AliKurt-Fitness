       ...
       <section id='bg-section' className=' w-100   bg-gradient'> 
          ...
          <div className='row w-100 justify-content-center '>
            <div className='col-md-10 d-lg-flex  align-items-center   items-center '>
              <div className='card  mt-md-5  items-center mx-auto rounded-4 '  >
             
            <Image  src="/images/hakkımda-img.jpg" alt='profil' width={400} height={600} className=' card-img-top   m-5 rounded-4  '></Image>
            </div>
